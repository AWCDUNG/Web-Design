...
function createGift() {
  ...
  const messages = [
    ...
    'Giáng Sinh vui vẻ, an lành và hạnh phúc bên gia đình! 🎅',
    'Chúc bạn một mùa Giáng Sinh tràn ngập niềm vui và những điều tốt đẹp! ❄️❤️',
    'Merry Christmas! Chúc bạn luôn khỏe mạnh, bình an và hạnh phúc! 🎄✨',
    'Giáng Sinh ấm áp, yêu thương ngập tràn! 🌟🎉',
    'Chúc mọi ước mơ của bạn trở thành hiện thực trong mùa lễ này! 🎁💫',
    'Noel an lành, niềm vui lan tỏa khắp nơi! ❄️🌈',
    'Chúc bạn một Giáng Sinh đầy ắp tiếng cười và hạnh phúc! 🎅❤️',
    'Giáng Sinh đến, chúc bạn nhận được thật nhiều yêu thương và quà tặng! 🎄🎁',
    'Hòa mình vào không khí Giáng Sinh và tận hưởng từng khoảnh khắc! ✨❄️',
    'Merry Christmas! Chúc bạn trọn vẹn yêu thương và ngập tràn niềm vui! 🎉❤️',
  ];
